import { CrowdFund } from '@prisma/client';
        ...
        import { crowdFundFilterAbleFields } from './crowdFund.constant';
        const createCrowdFund: RequestHandler = catchAsync(
          async (req: Request, res: Response) => {
            const CrowdFundData = req.body;
        
            const result = await CrowdFundService.createCrowdFund(
              CrowdFundData
            );
        ...
        const getAllCrowdFund = catchAsync(
          async (req: Request, res: Response) => {
        ...
        const updateCrowdFund: RequestHandler = catchAsync(
          async (req: Request, res: Response) => {
            ...
            const result = await CrowdFundService.updateCrowdFund(
              id,
              updateAbleData
            );
