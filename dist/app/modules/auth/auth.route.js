...
router.post('/verify-signup-token/:token', auth_controller_1.AuthController.verifySignupToken);
router.post('/resend/:email', auth_controller_1.AuthController.resendEmail);
